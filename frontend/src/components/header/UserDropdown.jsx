...
const profileImage = user?.profile_photo
  ? `${UPLOAD_URL}${user.profile_photo}`
  : "/images/user/owner.jpg";

  return (<div className="relative">
    <button onClick={toggleDropdown} className="flex items-center text-gray-700 dark:text-gray-400 dropdown-toggle text-xs">
      {user?.role_id !== 1 && (
...
/>
      ...
      <span className="block mr-1 font-medium text-theme-sm sm:text-sm text-xs">{user?.name || "User"}</span>
